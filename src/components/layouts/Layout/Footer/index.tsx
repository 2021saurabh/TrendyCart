      ...
      <div className={styles.container}>
        <div className={styles.profile}>
          <div className={styles.nav_wrapper}>
            <div className={styles.nav_title}>Trendy Cart</div>
            <div className={styles.subTitle}>
              Unleash your fashion. Find your trendy.
            </div>
            <div className={styles.socials_wrapper}>
              <div className={styles.socials}>
                <a
                  href="https://www.instagram.com/_.saurabhpandey/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FaInstagram />
            ...
            <div className={styles.subTitle}>
              All rights reserved.©️ 2024 Trendy Cart
            </div>
          </div>
        </div>
